...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'smportal';
...
ApplicationConfiguration.registerModule('access-tokens');
'use strict';
...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('oauth-clients');
'use strict';

// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('request-tokens');
'use strict';
...
/*
//Access tokens service used to communicate Access tokens REST endpoints
angular.module('access-tokens').factory('AccessTokens', ['$resource',
	function($resource) {
		return $resource('access-tokens/:accessTokenId', { accessTokenId: '@_id'
		}, {
			update: {
				method: 'PUT'
			}
